  ...
  return (
    <div className="flex flex-col gap-8 h-full max-w-3xl mx-auto w-full p-2 sm:p-4 pb-12">
      ...
      <div className={`p-8 sm:p-12 rounded-[3.5rem] border-4 border-zinc-400 shadow-brutal-lg text-center relative overflow-hidden ${resultTone.panel}`}>
        ...
        <div className="inline-block bg-white px-8 py-3 rounded-full border-4 border-zinc-400 shadow-brutal mt-2 relative z-10 transform rotate-1">
          <p className="text-2xl sm:text-3xl font-black text-zinc-800">
             {session.total_questions}もん中 <span className={`text-5xl mx-2 ${resultTone.score}`}>{session.correct_count}</span> もんせいかい！
          </p>
        </div>
        ...
        {earnedPoints > 0 && (
          <div className="mt-8 relative z-10 animate-points-pop">
            <div className="inline-flex flex-col items-center gap-2 bg-gradient-to-br from-amber-50 to-amber-100 px-10 py-5 rounded-[2rem] border-4 border-amber-300 shadow-brutal transform -rotate-1">
              <div className="flex items-center gap-2">
                <Star className="w-8 h-8 text-amber-500 fill-amber-300" />
                <span className="text-2xl sm:text-3xl font-black text-amber-900">ポイントゲット！</span>
                <Star className="w-8 h-8 text-amber-500 fill-amber-300" />
              </div>
              <div className="text-5xl sm:text-7xl font-black text-amber-700 tabular-nums tracking-tight">
                +{displayPoints}<span className="text-3xl sm:text-4xl ml-1">pt</span>
              </div>
              {isPerfect && bonusPoints > 0 && (
                <div className="bg-rose-100 text-rose-700 px-4 py-1 rounded-full text-lg sm:text-xl font-black border-2 border-rose-300 shadow-brutal-sm transform rotate-1">
      ...
      <div className="bg-white p-6 sm:p-10 rounded-[3rem] border-4 border-zinc-400 shadow-brutal mt-8">
        <div className="bg-emerald-100 border-4 border-zinc-400 shadow-brutal-sm px-6 py-3 rounded-full w-fit -rotate-2 mb-8">
