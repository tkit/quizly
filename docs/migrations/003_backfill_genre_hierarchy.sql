...
VALUES
  ...
  ('history', '歴史', NULL, 'landmark', 'むかしの出来事や人物', 'orange'),
...
INSERT INTO public.genres (id, name, parent_id, icon_key, description, color_hint)
VALUES
  ('math-basic', '算数ベーシック', 'math', 'calculator', '算数のきそ問題', 'blue'),
  ('history-basic', '歴史ベーシック', 'history', 'landmark', '歴史のきそ問題', 'orange'),
  ('science-basic', '理科ベーシック', 'science', 'flask', '理科のきそ問題', 'green')
ON CONFLICT (id) DO UPDATE SET
